...
![训练思想](http://yougth.github.io/img/word2vec/word2vec-1.png)

### One-Word Model

最简化版本如下图，就是输入输出都只有一个词

![One word model](http://yougth.github.io/img/word2vec/word2vec-2.png)
...
![矩阵表示](http://yougth.github.io/img/word2vec/word2vec-6.png)
...
![CBOW model](http://yougth.github.io/img/word2vec/word2vec-3.png)
...
![SkipGram model](http://yougth.github.io/img/word2vec/word2vec-4.png)
...
![Hierarchical Softmax](http://yougth.github.io/img/word2vec/word2vec-5.png)
