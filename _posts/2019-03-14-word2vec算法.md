...
![训练思想](/img/word2vec/word2vec-1.png)

### One-Word Model

最简化版本如下图，就是输入输出都只有一个词

![One word model](/img/word2vec/word2vec-2.png)
...
![矩阵表示](/img/word2vec/word2vec-6.png)
...
![CBOW model](/img/word2vec/word2vec-3.png)
...
![SkipGram model](/img/word2vec/word2vec-4.png)
...
![Hierarchical Softmax](/img/word2vec/word2vec-5.png)
