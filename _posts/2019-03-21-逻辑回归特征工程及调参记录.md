...
组合如上，其中注释掉的是组合后特征重要性低的一些特征。组合后**AUC为0.703**，虽然AUC提升不多，只有4个千分点，但是模型泛化能力以及个性化提升了不少,其中有很多组合特征的重要性很高，但是为什么AUC没有提升呢，目测已经接近这份数据的AUC上限了，什么是AUC的上限可以参考我直接对[AUC指标分析](http://yougth.github.io/2019/03/18/%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0%E4%B8%AD%E7%9A%84%E8%AF%84%E4%BC%B0%E6%8C%87%E6%A0%87/)对文章。
...
![特征重要性](http://yougth.github.io/img/logistic/lr_9.png)

![训练思想](http://yougth.github.io/img/logistic/lr_10.png)
